...
def pixel_to_world_trial(u, v, Zc, extrinsic):
    ...
    #One instance of Extrinsic, 20 points
#     H = np.array([[ 9.99433977e-01, -3.27920569e-02 , 7.51048691e-03 , 4.55458355e+00],
#  [-3.36110727e-02 ,-9.82775125e-01 , 1.81723277e-01 , 1.66403219e+02],
#  [ 1.42203967e-03 ,-1.81872853e-01 ,-9.83321028e-01 , 1.02661790e+03],
#  [ 0.00000000e+00  ,0.00000000e+00  ,0.00000000e+00 , 1.00000000e+00]])
    #Error propagates in the Y due to the tilt of the camera not being accounted for.
    #The Z distance is large. 


    #One instance of Extrinsic, 35 points
    # H = np.array([[ 9.99340917e-01, -3.60347362e-02, -4.38518370e-03,  5.30898917e+00],
    #             [-3.49424077e-02, -9.87640999e-01,  1.52788371e-01,  1.90209674e+02],
    #             [-9.83667583e-03, -1.52534441e-01, -9.88249201e-01,  1.02702194e+03],
    #             [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]])
    ...
    return world_c[0], world_c[1], world_c[2]
